# TSH-P-T
TSH Privacy Policy and TOS

This Terms of Service Agreement is entered into between wildgg ("Bot Owner") and the user ("User") of the "Tarkov Settings Helper" Discord bot (the "Bot").
...
This bot does not collect, store, or use any private or personal information. It only processes messages as needed to function within the server. No data is saved or shared.
If you have any questions, contact the bot Owner.
